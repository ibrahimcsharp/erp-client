...
export class RichluCostingReportService {
  ...
  async exportRichluExcelReport(excelData) {
    ...
    for (var itemCMQ1 of dataForExcelCMQ1) {
      ...
      worksheet.getCell(slCellCMQ1).value = c + rowCountAccessories1 + rowCountLable1 + rowCountPackging1 + cmqLastRow + 1;
    ...
    worksheet.getCell(FinalTotalCell1).value = {
      formula: `SUM(H${valFabric1}+H${valAccessories1}+H${valLable1}+H${valPaking1}+H${valProcesss1}+H${cmqLastRow})`,
      date1904: false
    };
    ...
    if (partList.length > 1) {
      ...
      worksheet.getCell(FinalTotalCell2).value = {
        formula: `SUM(R${valFabric2}+R${valAccessories2}+R${valLable2}+R${valPaking2}+R${valProcesss2}+R${cmqLastRow2})`,
        date1904: false
      };
...
if(IEDdata1.length > 0){
  ...
  var newRowNumber = val +2;
      ...
      worksheet.getCell(IEDat1stColoum).value = "Buyer";
      ...
      worksheet.getCell(IEDat2ndColoum).value = "Style";
      ...
      worksheet.getCell(IEDat3rdColoum).value = "Item";
      ...
      worksheet.getCell(IEDat4thColoum).value = "Order Qty";
      ...
      worksheet.getCell(IEDat5thColoum).value = "SMV";
      ...
      worksheet.getCell(IEDat6thColoum).value = "Machine";
      ...
      let IEDat7thColoum = "G" + newRowNumber;
      worksheet.getCell(IEDat7thColoum).value = "W/Munte";
      worksheet.getCell(IEDat7thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat7thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat8thColoum = "H" + newRowNumber;
      worksheet.getCell(IEDat8thColoum).value = "Wanted Eff(%)";
      worksheet.getCell(IEDat8thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat8thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat9thColoum = "I" + newRowNumber;
      worksheet.getCell(IEDat9thColoum).value = "Daily Prod'N";
      worksheet.getCell(IEDat9thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat9thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat10thColoum = "J" + newRowNumber;
      worksheet.getCell(IEDat10thColoum).value = "Hourly Prod'n";
      worksheet.getCell(IEDat10thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat10thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat11thColoum = "K" + newRowNumber;
      worksheet.getCell(IEDat11thColoum).value = "0.036";
      worksheet.getCell(IEDat11thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat11thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat13thColoum = "L" + newRowNumber;
      worksheet.getCell(IEDat13thColoum).value = "0.04";
      worksheet.getCell(IEDat13thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat13thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat14thColoum = "M" + newRowNumber;
      worksheet.getCell(IEDat14thColoum).value = "0.055";
      worksheet.getCell(IEDat14thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat14thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat15thColoum = "N" + newRowNumber;
      worksheet.getCell(IEDat15thColoum).value = "0.059";
      worksheet.getCell(IEDat15thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat15thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };

      let IEDat16thColoum = "O" + newRowNumber;
      worksheet.getCell(IEDat16thColoum).value = "Remarks";
      worksheet.getCell(IEDat16thColoum).fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "4167B8" },
        bgColor: { argb: "" },
      };
      worksheet.getCell(IEDat16thColoum).font = {
        bold: true,
        color: { argb: "FFFFFF" },
        size: 12,
      };
