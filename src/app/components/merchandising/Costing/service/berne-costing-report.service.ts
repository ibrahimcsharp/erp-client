...
export class BreneCostingReportService {
  ...
  async exportBerneExcelReport(excelData) {
    //debugger
    ...
    for (var itemPart1 of dataForExcelForFirstPart) {
      ...
      let totalPriceCellFab = "F" + costrowCountitemFirstPart; //row.getCell(5).address;
      ...
      let supplierNameCellFab = "G" + costrowCountitemFirstPart;// row.getCell(3).address;
      ...
      let remarksCellFab = "H" + costrowCountitemFirstPart; //row.getCell(5).address;
    ...
    let toalalFirstPartQ1 = "E" + valFirstPart;
    ...
    let toalaltoalalFirstPartQ1Cell1 = "F" + valFirstPart;
    ...
    if (dataForExcelForFirstPart.length > 0) {
      worksheet.getCell(toalaltoalalFirstPartQ1Cell1).value = {
        formula: `SUM(F${firstPartFirstRow}:F${firstPartLastRow})`,
        date1904: false
      };
    }
    ...
    let toalalSecondPartcCell111 = "G" + fobFirstPart;
    worksheet.getCell(toalalSecondPartcCell111).value = 0;
    if (dataForExcelForFirstPart.length > 0) {
      worksheet.getCell(toalalSecondPartcCell111).value = {
        formula: `G${valFirstPart}+(G${valFirstPart}*(${dataForFirstPart[0].buyingCommission}/100))`,
        date1904: false
      };
    }
    ...
    ///---------------double part--------------///
    if (partList.length > 1) {
      let style2 = worksheet.getCell("J2");
      style2.value = "Style ";
      style2.font = {
        name: "Calibri",
        size: 12,
      ...
      let styleName2 = worksheet.getCell("K2");
      ...
      let part2 = worksheet.getCell("J3");
      ...
      let partName2 = worksheet.getCell("K3");
      ...
      let season2 = worksheet.getCell("J4");
      ...
      let seasonName2 = worksheet.getCell("K4");
      ...
      let option2 = worksheet.getCell("L2");
      ...
      let optionData2 = worksheet.getCell("M2");
      ...
      let f11 = worksheet.getCell("J" + costRowCount);
      f11.value = "SL";
      f11.fill = {
        type: "pattern",
        pattern: "solid",
      ...
      let f7 = worksheet.getCell("P" + costRowCount);
      ...
      let f8 = worksheet.getCell("Q" + costRowCount);
      f8.value = "Remarks";
      f8.fill = {
        type: "pattern",
        pattern: "solid",
      ...
      for (var itemSecond of dataForExcelForSecondPart) {
        ...
        let slCell = "J" + costRowCount2; //row.getCell(5).address;
        ...
        let qtyDzCell = "L" + costRowCount2; //row.getCell(4).address;
        ...
        let unitCell = "M" + costRowCount2; //row.getCell(5).address;
        ...
        let unitPriceCell = "N" + costRowCount2; //row.getCell(5).address;
        ...
        let totalPriceCell = "O" + costRowCount2; //row.getCell(5).address;
        ...
        worksheet.getCell(totalPriceCell).value = {
          formula: `(L${costRowCount2}*N${costRowCount2})`,
          date1904: false
        }


        let supplierNameCell = "P" + costRowCount2;// row.getCell(3).address;
       ...
       // worksheet.getCell(supplierNameCell).alignment = {  vertical: "middle", horizontal: "left" , wrapText: true};
        ...
        let remarksCell = "Q" + costRowCount2; //row.getCell(5).address;
      ...
      let toalalSecondPartcCell1 = "O" + valSecondPart;
      ...
      if (dataForExcelForSecondPart.length > 0) {
        worksheet.getCell(toalalSecondPartcCell1).value = {
          formula: `SUM(O${secondtPartFirstRow}:O${secondtPartLastRow})`,
          date1904: false
        };
      }
      ...
      let toalalSecondPartcCell122 = "P" + fobSecondPart;
      worksheet.getCell(toalalSecondPartcCell122).value = 0;
      if (dataForExcelForSecondPart.length > 0) {
        worksheet.getCell(toalalSecondPartcCell122).value = {
          formula: `P${valSecondPart}+(P${valSecondPart}*(${secondPartData[0].buyingCommission}/100))`,
          date1904: false
        };
      }
