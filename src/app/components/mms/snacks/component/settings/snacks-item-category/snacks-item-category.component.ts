...
@Component({
  selector: 'app-snacks-item-category',
  templateUrl: './snacks-item-category.component.html',
  styleUrls: ['./snacks-item-category.component.scss']
})
export class SnacksItemCategoryComponent implements OnInit {
