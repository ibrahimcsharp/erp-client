...
@Component({
  selector: 'app-pending-department-task',
  templateUrl: './pending-department-task.component.html',
  styleUrls: ['./pending-department-task.component.scss']
})
export class PendingDepartmentTaskComponent implements OnInit {
  Items: any[];
  ...
  cmds(row) {
    this.items = [
      ...
      {
        label: 'Assign', icon: 'pi pi-user-plus', command: () => {
          this.TaskAssign(row);
        }
      },
      {
