...
@Component({
  selector: 'app-ongoing-department-task',
  templateUrl: './ongoing-department-task.component.html',
  styleUrls: ['./ongoing-department-task.component.scss']
})
export class OngoingDepartmentTaskComponent implements OnInit {
  Items: any[];
